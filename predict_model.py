...
# ---------------------------------
#escolher apenas os mais interessantes
df = dfs[[
...
ensemble_model = VotingClassifier(
    estimators=[('svm', best_svm), ('rf', best_rf), ('mlp', best_mlp)], voting='hard'
)
...
# Salvar o modelo
joblib.dump(ensemble_model, "PSA_ensemble_model.pkl")
